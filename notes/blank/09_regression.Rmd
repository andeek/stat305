...
We can also estimate the mean response at the set of covariate values, $(x_1,x_2,\dots,x_{p-1})$. Under the model assumptions, the estimated mean response, $\mu_{y|x}$, at $\boldsymbol x=(x_1,x_2,\dots,x_{p-1})$ is 
...
![How to get predicted values and standard errors.](images/get_multi_sterror.png)
