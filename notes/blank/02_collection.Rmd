...
\begin{df}
A \emph{block} of experimental units, experiental times of observation, experimental conditions, etc. is a homogeneous group within which different levels of primary experimental variables can be applied and compared in a relatively uniform environment.
\end{df}
...
There are many subtelties that enter into the planning of an effective experiment. There are some standard "skeletons" of plans that can help with planning an experiment.
...
A $3\times 3$ factorial eperiment is run with the levels of concentration being 50\%, 75\%, and 100\% HF and the levels of time being 30 sec., 60 sec, 120 sec. 18 damaged rods were allocated - two apiece - to eaching of the nine treatment combinations for testing. This was done at random by labeling the rods 01-18, placing numbered slips of paper in a hat, mixing, drawing two out for 30 sec. and 50\%, then drawing two out for 30 sec. and 75\%, etc. The slips of paper were also used to determine the order of testing and the order of damaging the rods.
