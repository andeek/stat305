...
Weekly homework assignments, along with their respective due dates, are be posted at <http://andeekaplan.com/stat305/materials.html>. Homeworks will usually be due on *Thursdays* at the *beginning of class* (unless otherwise notified in class and on the website). Submission must be in hard copy form (printed + stapled) except under extenuating circumstances. Please note, there will be a homework assignment due during *dead week*.
